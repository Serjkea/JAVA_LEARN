...
public class ConfigFactory {
	...
	public static Config<Object> getXmlConfig(Object configuration, String path, Class objClass) {
		return new XmlConfig(configuration, path, objClass);
	}
	
	public static Config<Object> getXmlConfig(Object configuration, Class objClass) {
		return new XmlConfig(configuration, objClass);
	}
